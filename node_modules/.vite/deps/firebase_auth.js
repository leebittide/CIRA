...
// node_modules/@firebase/auth/dist/esm2017/index-839de510.js
var FactorId = {
...
var UserImpl = class _UserImpl {
  ...
  _clone(auth) {
    return new _UserImpl(Object.assign(Object.assign({}, this), { auth, stsTokenManager: this.stsTokenManager._clone() }));
  }
  _onReload(callback) {
    _assert(
      !this.reloadListener,
...
var PhoneMultiFactorInfo = class _PhoneMultiFactorInfo extends MultiFactorInfoImpl {
  constructor(response) {
    super("phone", response);
    this.phoneNumber = response.phoneInfo;
  }
  static _fromServerResponse(_auth, enrollment) {
    return new _PhoneMultiFactorInfo(enrollment);
  }
};
...
var MultiFactorSessionImpl = class _MultiFactorSessionImpl {
  ...
  static _fromIdtoken(idToken) {
    return new _MultiFactorSessionImpl("enroll", idToken);
  }
...
@firebase/auth/dist/esm2017/index-839de510.js:
  (**
   * @license
